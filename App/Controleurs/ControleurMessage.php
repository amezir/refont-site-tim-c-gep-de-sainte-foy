...
class ControleurMessage
{
    ...
    public function creer(): void
    {
        ...
        $tDonnees = array("tValidation"=>$tValidation , "responsables"=>$responsables , "retroaction"=>$retroaction);
    ...
    public function insert(): void
    {
        session_start();
        echo 'passé ici';
        $contenuFichierJson = file_get_contents("../public/liaisons/json/messages-erreur_form.json");
